...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "▶ Начать":
        ...
        await update.message.reply_text(random.choice([
            "Здесь, брат. Как всегда.", "Конечно тут.", "А куда я денусь? 😤",
            "Тут, братан. Всегда на связи.", "Да, я тут. Держись.", "Тут. Как договаривались."
        ]))
        await asyncio.sleep(random.uniform(1.8, 3.2))
        await context.bot.send_message(chat_id=chat_id, text=random.choice([
            "Держимся сегодня. Вместе.", "Ты сильный.", "Сегодня наш день.",
            "Горжусь тобой.", "Так держать.", "Ты справишься."
        ]))
